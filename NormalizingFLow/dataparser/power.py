...
def main():
    ...
    for i in range(6):
        plt.subplot(2, 3, i + 1, title='Histogram of dim:{}'.format(i))
        plt.hist(dataset.data[:, i].reshape(-1), bins=250)
    plt.show()


if __name__ == '__main__':
    os.environ['DATAROOT'] = 'D:\/Study_Files\/UCSB\Projects\/NFWorkSpace\/datasets'
    main()
